...
class softServo {
  ...
  public:
    ...
    softServo(int enablePin, int aPin, int bPin, int potPin, float kp, float ki, float kd);

    void setup(int enablePin, int aPin, int bPin, int potPin, float kp, float ki, float kd);
