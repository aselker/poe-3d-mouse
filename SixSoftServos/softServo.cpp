...
softServo::softServo(int enablePin, int aPin, int bPin, int potPin, float kp, float ki, float kd) {

  setup(enablePin, aPin, bPin, potPin, kp, ki, kd);

}

void softServo::setup(int enablePin, int aPin, int bPin, int potPin, float kp, float ki, float kd) {
